...
| **Prev_family_name** | If there are more than one determination given to the species, enter the taxonomic family that the species was indentified to.|
| **Prev_family_name** | If there are more than one determination given to the species, enter the taxonomic family that the species was previously indentified to (i.e. look at the older determination label).|
| **Prev_scientific_name** | As with "Prev_family_name" but for the scienific name of the specimen.|
