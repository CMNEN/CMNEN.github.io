...
| **Specimen_notes** | Any notes related to this specific specimen. Any notes that must be associated to this particular specimen should be entered here. |
...
| **Coll_method** | Collection method (e.g. "VFIT", "Aerial net", "Lindgren funnel", "Malaise w/ pan traps", "Litter sifter sampling", "Beating vegetation", etc.). This is an extremely important column! Check in with your supervisor if you are not sure whether an acronymn refers to a collection method or something else. |
